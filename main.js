...
/* harmony import */ var _capacitor_device__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @capacitor/device */ 4744);
/* harmony import */ var _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @capacitor/status-bar */ 9326);
/* harmony import */ var _shared_constants_constant_class__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/constants/constant.class */ 6443);
...
let AppComponent = class AppComponent {
  ...
  ngOnInit() {
    ...
    return (0,C_Users_MSCTU_Desktop_Projects_app_partner_ver2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_7__.StatusBar.setStyle({
          style: _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_7__.Style.Dark
        });
      } catch (e) {}

      const info = yield _capacitor_device__WEBPACK_IMPORTED_MODULE_6__.Device.getInfo();
      const deviceId = yield _capacitor_device__WEBPACK_IMPORTED_MODULE_6__.Device.getId(); // console.log(info);
      ...
      if (_this.platform.is('ios') || _this.platform.is('android')) {
        ...
        _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__.PushNotifications.requestPermissions().then(result => {
          if (result.receive === 'granted') {
            ...
            _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__.PushNotifications.register().then(en => {// console.log('PushNotifications.register()');
            });
        ...
        _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__.PushNotifications.addListener('registration', token => {
          ...
          _this.localStorage.set('fcmToken', token.value).then(res => {
        ...
        _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__.PushNotifications.addListener('pushNotificationReceived', notification => {// alert('Push received: ' + JSON.stringify(notification));
        });
        _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__.PushNotifications.addListener('pushNotificationActionPerformed', notification => {
          ...
          if (notiType === _shared_constants_constant_class__WEBPACK_IMPORTED_MODULE_8__.Constant.NOTIFICATION_TYPE_SMS || notiType === _shared_constants_constant_class__WEBPACK_IMPORTED_MODULE_8__.Constant.NOTIFICATION_TYPE_MEDIA) {
          ...
          } else if (notiType === _shared_constants_constant_class__WEBPACK_IMPORTED_MODULE_8__.Constant.NOTIFICATION_TYPE_CONVERSATION) {
            _this.router.navigate(['/main/tab4']);
          } else if (notiType === _shared_constants_constant_class__WEBPACK_IMPORTED_MODULE_8__.Constant.NOTIFICATION_TYPE_POLLING) {
            _this.router.navigate(['/student-polling']);
          } else if (notiType === _shared_constants_constant_class__WEBPACK_IMPORTED_MODULE_8__.Constant.NOTIFICATION_TYPE_HOMEWORK) {
...
/* harmony import */ var ngx_ionic_image_viewer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-ionic-image-viewer */ 7353);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        ...
        imports: [
            ...
            _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonicModule.forRoot({ animated: false, swipeBackEnabled: false }),
        ...
        providers: [_angular_common__WEBPACK_IMPORTED_MODULE_11__.DatePipe, { provide: _angular_router__WEBPACK_IMPORTED_MODULE_12__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonicRouteStrategy }, _ionic_native_app_version_ngx__WEBPACK_IMPORTED_MODULE_2__.AppVersion, src_app_services_general_service__WEBPACK_IMPORTED_MODULE_3__.GeneralService],
...
let GeneralService = class GeneralService extends _shared_services_base_service__WEBPACK_IMPORTED_MODULE_0__.BaseService {
    //taikhoan
    getTaikhoan() {
...
GeneralService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
NotificationService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], NotificationService);
