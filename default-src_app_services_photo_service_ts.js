...
let PhotoService = class PhotoService {
  ...
  choosePhotoFromGallery() {
    ...
    return (0,C_Users_MSCTU_Desktop_Projects_app_partner_ver2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      console.log('choosePhotoFromGallery'); // Take a photo
      // Take a photo
  ...
  cropImage(src, newX, newY) {
    ...
    return new Promise((res, rej) => {
      ...
      inputImage.onload = () => {
        ...
        console.log(outputWidth, outputHeight); // calculate the position to draw the image at
...
PhotoService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
  providedIn: 'root'
})], PhotoService);
